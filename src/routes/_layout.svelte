...
<div class="bg-white">
  <div
    ...
    <div class="mt-8 flex justify-center">
      <a
        ...
        <svg
          ...
          <path
            ...
            24.63-47.44 0l-38.53-144.8h32.57l29.71 113.72 29.57-113.72h32.58z" />
        </svg>
      </a>
      <a
      ...
      <a
        href="https://linkedin.com/company/chingu-os"
        target="_blank"
        rel="noopener noreferrer"
        class="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <svg 
            ...
            style="enable-background:new 0 0 490.732 490.732;"
            fill="currentColor">
          <g>
            <g>
      ...
      <a
        href="https://www.youtube.com/channel/UCS7zmJXbe7FgTC3sHlUf4jw/feed"
        target="_blank"
        rel="noopener noreferrer"
        class="ml-6 text-gray-400 hover:text-gray-500">
        ...
        fill="currentColor"
          ...
          <path
            d="m0 1864.11v.11c1.5 55.5 2 111.32 11.32 166.47 9.92 58.35 24.1
            ...
            227.79-20.95 78.13-25.51 157.81-25.62 238.06"
            fill="#fff" />
          <path d="m0 .79h2498v2498h-2498z" fill="none" />
          <path
            d="m1293.24 1938.65-409.54-7.49c-132.6-2.61-265.53
            ...
            339.49-195.16 509.89-292.9-171.7-98.4-339.49-195.16-509.89-292.9z"
            fill="currentColor" />
        </svg>
      </a>
      <a
        ...
        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 195 195">
          <g fill="none">
            <path d="M0 0h195v195H0z" fill="currentColor" />
            <path
              d="M46.534 65.216a5.074 5.074 0 0 0-1.651-4.28L32.65
              ...
              16.691v2.201H31v-2.2l13.76-16.692a6.663 6.663 0 0 0 1.774-5.747z"
              fill="#fff" />
          </g>
        </svg>
      </a>
    ...
    <div class="mt-8">
      <p class="text-center text-base leading-6 text-gray-400">
        &copy; { currentYear } Chingu, Inc. All rights reserved.
      </p>
    </div>
  </div>
</div>
