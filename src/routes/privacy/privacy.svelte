...
<main class="py-10 max-w-3xl mx-auto sm:px-6 lg:px-8">
  ...
  <h2 class="mt-8 text-3xl font-bold tracking-tighter">Privacy Notice</h2>
  ...
  <ol class="mt-4 ml-8 list-decimal">
    <li>
  ...
  <h2 class="mt-8 text-3xl font-bold tracking-tighter">
  ...
  <p class="mt-4">
    You may opt out of any future contacts from us at any time by terminating
    your account. You can do the following at any time by contacting us via the
  ...
  <h2 class="mt-8 text-3xl font-bold tracking-tighter">Security</h2>
  ...
  <p class="mt-4">
    Wherever we collect information it is encrypted and transmitted to us in a
    secure way. You can verify this by looking for a lock icon in the address
  ...
  <p class="mt-4">
    ...
    we also protect your information offline. Only staff members who need the
    information to perform a specific job (for example, processing support
    tickets) are granted access to personally identifiable information.
  </p>
